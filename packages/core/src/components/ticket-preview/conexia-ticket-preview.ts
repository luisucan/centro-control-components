...
const placeholderImageUrl =
  ...
  encodeURIComponent(
    `<svg xmlns="http://www.w3.org/2000/svg" width="320" height="160">
      ...
      <text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" fill="#64748b" font-size="16" font-family="Arial, sans-serif">Imagen no disponible</text>
    </svg>`
  );
const placeholderQrUrl =
  "data:image/svg+xml;utf8," +
  encodeURIComponent(
    `<svg xmlns="http://www.w3.org/2000/svg" width="200" height="200">
      <rect width="100%" height="100%" fill="#f8fafc" stroke="#e2e8f0" />
      <text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" fill="#64748b" font-size="18" font-family="Arial, sans-serif">QR</text>
    </svg>`
  );
