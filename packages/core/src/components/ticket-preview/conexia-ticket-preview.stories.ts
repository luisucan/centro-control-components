...
const meta: Meta = {
  title: "Core/Ticket Preview",
  component: "conexia-ticket-preview"
};
...
export const Default: Story = {
  render: () => html`
    <conexia-ticket-preview .content=${sampleContent}></conexia-ticket-preview>
  `
};
